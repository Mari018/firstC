...
public final class Field {
   ...
   /* public static void clearObstacle(Obstacle obstacle) {
        Position obstacle1 = obstacle.getPosition();
        screen.putString(obstacle1.getCol(), obstacle1.getRow(), " ", null, null);
    }*/
    ...
    public static void drawObstacle(Obstacle obstacle) {
        screen.putString(obstacle.getPosition().getCol(), obstacle.getPosition().getRow(), Obstacle, Terminal.Color.RED, null);
    }
